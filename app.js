...
var tokyo = {
    locationName: 'Tokyo',
    minCustomersPerHour: 34,
    maxCustomersPerHour: 67,
    avgCookiesPerSale: 20.5,
    customersEachHour: [],
    cookiesEachHour: [],
    totalDailyCookies: 0,
    calcCustomersEachHour: function () {
   ...
   var dubai = {
    locationName: 'Dubai',
    minCustomersPerHour: 8,
    maxCustomersPerHour: 34,
    avgCookiesPerSale: 12.1,
    customersEachHour: [],
    cookiesEachHour: [],
    totalDailyCookies: 0,
    calcCustomersEachHour: function () {
   ...
   var paris = {
    locationName: 'Paris',
    minCustomersPerHour: 19,
    maxCustomersPerHour: 70,
    avgCookiesPerSale: 29.9,
    customersEachHour: [],
    cookiesEachHour: [],
    totalDailyCookies: 0,
    calcCustomersEachHour: function () {
   ...
   var lima = {
    ...
    maxCustomersPerHour: 19,
    avgCookiesPerSale: 4.7,
    customersEachHour: [],
    cookiesEachHour: [],
    totalDailyCookies: 0,
    calcCustomersEachHour: function () {
